"""
AWS lambda function to receive database query from Amazon API gateway
in form of GET request and serve the result
...
def handler(event,context):
    ...
    try:
        query = event["queryStringParameters"]["query"]                 # dynamically get query string from request query string
        ...
        return {"body": str(results_list), "headers": {},
                "statusCode": 200,
                "isBase64Encoded": "false"}
